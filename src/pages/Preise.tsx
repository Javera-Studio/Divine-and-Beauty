            ...
            {visible.map((cat) => (
              <div
                ...
                style={{
                  ...
                  borderRadius: 22,
                  padding: "28px 26px",
                  boxShadow: "0 4px 24px rgba(185,130,165,0.07)",
              ...
              >
                <h3
                  ...
                  style={{
                    ...
                    marginBottom: 18,
                    paddingBottom: 14,
                    borderBottom: "1px solid rgba(214,183,109,0.2)",
                    display: "flex",
                    alignItems: "center",
                    gap: 8,
                  }}
                ...
                {cat.items.map((item) => (
                  <div key={item.name} className="dv-prow">
                    ...
                    <span className="dm dv-pv" style={{ color: C.gold, fontSize: 14, fontWeight: 600, transition: "color .2s" }}>
                      {item.price}
                    </span>
                  </div>
                ))}
