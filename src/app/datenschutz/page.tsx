...
export const metadata: Metadata = {
  title: "Datenschutz – Divine Beauty & Nails Studio Wien",
  description: "Datenschutzerklärung des Divine Beauty & Nails Studio Wien gemäß DSGVO.",
  alternates: { canonical: "https://divinenails.at/datenschutz" },
...
const MUTED = "#7A6E72";
const BG = "#FFF7F2";
const heading: React.CSSProperties = { fontFamily: "'Playfair Display', serif", color: PINK, fontSize: 16, marginBottom: 10, marginTop: 0 };
const body: React.CSSProperties = { color: MUTED, fontSize: 13, lineHeight: 1.88, margin: 0 };
  ...
  return (
    <div style={{ background: BG, minHeight: "100vh", padding: "60px 0 120px", fontFamily: "'DM Sans', sans-serif" }}>
      <div style={{ maxWidth: 860, margin: "0 auto", padding: "0 24px" }}>
        <Link href="/" style={{ color: PINK, fontSize: 13, textDecoration: "none", letterSpacing: 1.5, textTransform: "uppercase" }}>
          ← Zurück zur Startseite
        </Link>
        <h1 style={{ fontFamily: "'Playfair Display', serif", color: TEXT, fontSize: 36, margin: "24px 0 6px" }}>Datenschutzerklärung</h1>
        ...
        <div style={section}>
          ...
          <p style={body}>Danijela Bošković<br />Klosterneuburger Straße 98<br />1200 Wien<br />Österreich<br /><br />E-Mail: kontakt@divinenails.at<br />Telefon: +43 676 3633721</p>
        </div>

        <div style={section}>
          <h3 style={heading}>2. Zugriffsdaten und Hosting</h3>
          <p style={body}>Beim Besuch dieser Website werden automatisch Informationen durch den Hosting-Anbieter gespeichert. Dazu gehören insbesondere:</p>
          ...
          <p style={{ ...body, marginTop: 8 }}>Diese Daten dienen ausschließlich der technischen Bereitstellung und Sicherheit der Website.</p>
        </div>
        ...
        <div style={section}>
          ...
          <p style={body}>
            ...
            <strong>Anbieter:</strong><br />Web3Forms<br /><br />
            Weitere Informationen zur Datenverarbeitung durch Web3Forms finden Sie in der{" "}
            <a href="https://web3forms.com/privacy" target="_blank" rel="noopener noreferrer" style={{ color: PINK }}>Datenschutzerklärung des Anbieters</a>.<br /><br />
        ...
        <div style={section}>
          ...
          <p style={body}>
            ...
            <a href="https://privacycenter.instagram.com/" target="_blank" rel="noopener noreferrer" style={{ color: PINK }}>privacycenter.instagram.com</a>
          </p>
        </div>
        ...
        <div style={section}>
          ...
          <p style={body}>
            ...
            Anbieter:<br />Google Ireland Limited<br />Gordon House, Barrow Street<br />Dublin 4, Irland<br /><br />
            Weitere Informationen:{" "}
            <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" style={{ color: PINK }}>policies.google.com/privacy</a>
          </p>
        </div>
        ...
        <div style={section}>
          ...
          <p style={{ ...body, marginTop: 12 }}>
            ...
            Österreichische Datenschutzbehörde<br />Barichgasse 40–42<br />1030 Wien<br />
            <a href="https://www.dsb.gv.at" target="_blank" rel="noopener noreferrer" style={{ color: PINK }}>www.dsb.gv.at</a>
          </p>
        </div>
      </div>
    </div>
