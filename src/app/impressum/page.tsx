...
export const metadata: Metadata = {
  title: "Impressum – Divine Beauty & Nails Studio Wien",
  description: "Impressum: Divine Beauty & Nails Studio, Inhaberin Danijela Bošković, Klosterneuburger Straße 98, 1200 Wien.",
  alternates: { canonical: "https://divinenails.at/impressum" },
  ...
  return (
    <div style={{ background: BG, minHeight: "100vh", padding: "60px 0 120px", fontFamily: "'DM Sans', sans-serif" }}>
      <div style={{ maxWidth: 860, margin: "0 auto", padding: "0 24px" }}>
        ...
        <p style={{ color: MUTED, fontSize: 13, lineHeight: 1.6, marginBottom: 32 }}>Angaben gemäß § 5 ECG</p>
        {ROWS.map(([k, v]) => (
